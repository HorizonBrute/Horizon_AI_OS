...
| context-cost | `/context-cost` | `#lowcost` | Report harness context overhead (KB, words, ~tokens) for a given path — walks the directory tree collecting CLAUDE.md, agents.md, and @-import files the harness auto-loads. Junction → skills_bin/context-cost. |
