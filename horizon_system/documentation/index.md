...
| `horizon_system/documentation/model_prefs_details.md` | Model Preferences — Reference | Full reference for the model-preference layer: member grammar, slot descriptions, group purposes, task-class routing format, scope precedence and merge rules, and reliability framing. Companion to the directive spec (`$HORIZON_ETC/horizon_aios_model_prefs.md`) and setup guide (`system/model_preferences.md`). |
