...
| `horizon_system/ai_os_etc/horizon_aios_model_prefs.md` | Model Preferences — Horizon AIOS | User-editable, advisory preferences for the model used when harnesses spawn agents or sub-agents. Loaded into every session via @-import; harnesses apply in good faith. |
