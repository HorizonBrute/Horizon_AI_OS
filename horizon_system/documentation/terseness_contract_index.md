...
| `brains/<name>/CLAUDE.md` | Harness — auto, brain sessions | Thin @-import entry: brain `agents.md` + `brain_invariants.md` + `brain_core.md`; no prose |
| `brains/<name>/brain_core.md` | @-import chain from `brains/<name>/CLAUDE.md` | Brain identity, role, knowledge, behaviors; keep terse, no large doc blocks |
| `brains/<name>/brain_invariants.md` | @-import chain from `brains/<name>/CLAUDE.md` | Brain hard rules (security ref + brain-specific); terse |
