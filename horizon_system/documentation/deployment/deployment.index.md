...
| DOC-0056 | deployable_modules.md | deployment/deployable_modules.md | Installing a deployable_module (standalone git repo + own installer) into an AIOS instance: clone-under-deployed_packages + registry + skill + context-pointer + admin-guide model, HORIZON_* prereqs, placement/role, sync durability, lifecycle, verification, troubleshooting | DOC-0021, DOC-0033 | implementation | File |
