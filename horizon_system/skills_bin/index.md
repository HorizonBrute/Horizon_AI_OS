...
| model-prefs-test | `/model-prefs-test` | Test how each model group resolves in the current runtime (dry-run), or spawn small agents by group to confirm the spawn honors the config and self-report the model (--live) |
