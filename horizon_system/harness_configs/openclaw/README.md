...
Place your OpenClaw-specific configuration in this directory as `openclaw.json` (or `openclaw.json5`). A template is provided at `$HORIZON_SYSTEM/harness_configs/openclaw/openclaw.json.template`.
