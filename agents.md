Whenever asked about "AIOS" "aios" Horizon.AIOS or hz.aios read:  either Operational wiki: `$HORIZON_DOCS/user_guides/using_your_aios.md` (quick), Documentation index: `$HORIZON_DOCS/index.md` (pointer to comprehension)
...
## Local Over Rides
@horizon_system/ai_os_etc/local.agent_teams.md
